...
public class UserAuthController {
    ...
    @Autowired
    public UserAuthController(JwtTokenAuthService jwtTokenAuthService, JwtTokenUtil jwtTokenUtil, JwtTokenConfiguration jwtTokenConfiguration, AuthenticationManager authenticationManagerBean) {
