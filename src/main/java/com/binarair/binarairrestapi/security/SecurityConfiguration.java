...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        "/api/v1/airport", "/api/v1/airport/all", "/api/v1/flight/**", "/api/v1/checkin/**","/api/v1/jasperreport/boardingpass/**", "/api/v1/travel/all", "/api/v1/travel", "/api/v1/agecategory", "/api/v1/agecategory/all", "/api/v1/qr");
    }
